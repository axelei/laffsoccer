...
public class PlayerStateKeeperDivingMiddleTwo extends PlayerState {

	private Ball ball;
	KeeperFrame active;
	KeeperFrame[] frames = new KeeperFrame[6];

	public PlayerStateKeeperDivingMiddleTwo(Player player) {
		super(player);
