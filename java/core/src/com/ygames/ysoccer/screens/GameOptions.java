...
class GameOptions extends GLScreen {
    ...
    private class PlayerCountryButton extends Button {
        ...
        PlayerCountryButton() {
            setColors(0x1F1F95);
            setGeometry(game.gui.WIDTH / 2 + 30, 400, 440, 38);
            setText("", Font.Align.CENTER, Assets.font14);
        }
    ...
    private class MaxPlayerValueLabel extends Button {
        ...
        MaxPlayerValueLabel() {
            setColors(0x800000);
            setGeometry(game.gui.WIDTH / 2 - 30 - 440, 450, 440, 38);
            setText("", Font.Align.CENTER, Assets.font14);
            setActive(false);
        }
    ...
    private class MaxPlayerValueButton extends Button {
        ...
        MaxPlayerValueButton() {
            setColors(0x1F1F95);
            setGeometry(game.gui.WIDTH / 2 + 30, 450, 300, 38);
            setText("", Font.Align.CENTER, Assets.font14);
        }
    ...
    private class CurrencyButton extends Button {
        ...
        CurrencyButton() {
            setColors(0x1F1F95);
            setGeometry(game.gui.WIDTH / 2 + 340, 450, 130, 38);
            setText("", Font.Align.CENTER, Assets.font14);
        }
