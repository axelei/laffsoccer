...
class ControlsSetup extends GLScreen {
    ...
    ControlsSetup(GLGame game) {
        ...
        for (int port = 0; port < 2; port++) {
            ...
            if (port == 0) {
                ...
                selectedWidget = inputDeviceButton;
            }
            pos++;
        }
    ...
    private class JoystickListener implements ControllerListener {
    ...
    private class SetupInputProcessor implements InputProcessor {
