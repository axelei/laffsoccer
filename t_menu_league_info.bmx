...
Type t_menu_league_info Extends t_game_mode
	...
	Method New()
		...
		''season/pitch type
		w = New t_button
		w.set_geometry(512 -370, 200, 440, 34)
		...
		''season start
		w = New t_button
		w.set_geometry(512 +90, 200, 100, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		''season separator
		w = New t_button
		w.set_geometry(512 +190, 200, 40, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		w.set_text("-", 0, 14)
		w.active = False
		w.visible = (league.byseason = True)
		...
		''season end
		w = New t_button
		w.set_geometry(512 +230, 200, 100, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		''pitch type
		w = New t_button
		w.set_geometry(512 +90, 200, 240, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		''time (day/night)
		w = New t_button
		w.set_geometry(512 -370, 245, 440, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		w = New t_button
		w.set_geometry(512 +90, 245, 240, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		''number of teams
		w = New t_button
		w.set_geometry(512 -370, 290, 440, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		w = New t_button
		w.set_geometry(512 +90, 290, 240, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		''play each team
		w = New t_button
		w.set_geometry(512 -370, 335, 440, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		w = New t_button
		w.set_geometry(512 +90, 335, 240, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		''points for a win
		w = New t_button
		w.set_geometry(512 -370, 380, 440, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		w = New t_button
		w.set_geometry(512 +90, 380, 240, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		''substitutes
		w = New t_button
		w.set_geometry(512 -370, 425, 440, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		w = New t_button
		w.set_geometry(512 +90, 425, 240, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		''bench size
		w = New t_button
		w.set_geometry(512 -370, 470, 440, 34)
		w.set_colors($666666, $8F8D8D, $404040)
		...
		w = New t_button
		w.set_geometry(512 +90, 470, 240, 34)
		w.set_colors($666666, $8F8D8D, $404040)
